...
public class PeopleController {
    ...
    // in this case because of @ResponseBody
    // Note: To CREATE we use POST method
    @PostMapping("/peopleLast")
    public @ResponseBody String createPersonByLast(@RequestBody Person person) {
        System.out.println(person);
        peopleList.put(person.getLastName(), person);
        return "New person, whose last name is "+ person.getLastName() + ", Saved";
    }
    ...
    @GetMapping("/people/{lastName}")
 	public @ResponseBody Person getPersonByLast(@PathVariable String lastName) {
